...
const chatembed = new MessageEmbed()
  .setColor("ffffff")
  .setDescription(`<:evett:793841629009281024> • <@${losxstg.user.id}> Aramıza Hoşgeldin, Keyifli Vakitler Geçirmeni Dilerim.`)
chat.send(chatembed)
...
.setDescription(`<a:zil:793841635779149824> • <@${losxstg.user.id}>, <@${message.author.id}> tarafından ${erkekrol} olarak kaydedildi.`)
.setColor('PURPLE')
message.react(emoji)
